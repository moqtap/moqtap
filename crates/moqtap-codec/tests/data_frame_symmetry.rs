...
//!
//! Not every combination names a frame. Drafts 15 and 17-19 declare eight of
...
/// The flag bits drafts 15-19 give a datagram type byte: 0x01 properties,
...
/// Whether drafts 15-19 define the datagram type byte `ty`.
///
...
/// The half of `type_bytes(flag_bits)` drafts 15-19 define, in sweep order.
#[cfg(any(
    feature = "draft15",
    feature = "draft16",
    feature = "draft17",
...
/// The half of `type_bytes(flag_bits)` drafts 15-19 declare invalid, in sweep
...
#[cfg(any(feature = "draft15", feature = "draft17", feature = "draft18", feature = "draft19"))]
...
/// `0x08` bit, and drafts 17-19 renamed the extension headers to properties.
///
...
/// bytes drafts 17-19 declare invalid are swept here instead, and both ends
