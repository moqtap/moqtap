#![cfg(feature = "draft20")]
//! Draft-20 forbids Object Properties on an Object whose status is not Normal,
...
fn properties_on_a_non_normal_status_decode_and_are_reported_as_forbidden() {
    ...
    assert!(
        ...
        "properties on End of Group are forbidden by draft-20 Section 11.2.1.2 and must be \
         reported as such"
    );
}
