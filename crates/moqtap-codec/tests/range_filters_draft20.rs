//! Draft-20's Range Filters, and the two things about them that are easy to
//! get wrong in opposite directions.
//!
//! Section 5.1.4 — draft-19's Section 5.1.3, renumbered — gives five parameter
...
//! what draft-20 did was replace the one-line shorthand with proper figures,
...
/// asserted rather than assumed. Draft-20 answers a bad Range Filter with a
...
/// # What it catches
///
/// Calling the reader from draft-20's `decode_parameters` — the shape the
