...
//!
//! Unchanged from draft-16: 0x0 Normal, 0x3 End of Group, 0x4 End of Track.
//! The set narrowed to these three at draft-16, which dropped Object Does Not
//! Exist (0x1); draft-17 carries the same three forward.

/// Object status values, from MoQ Transport draft-17 Section 10.2.1.1
/// "Object Status".
///
...
impl ObjectStatus {
    /// Every status draft-17 assigns, in ascending wire order.
    ///
    ...
    /// Convert a raw u64 to an `ObjectStatus`, or `None` if draft-17 does not
    /// assign that value.
    ...
    ///
    /// A draft-17 status datagram carries its status as one bare byte rather
