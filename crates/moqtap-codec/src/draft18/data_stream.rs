...
impl FetchObjectWriter {
    ...
    fn identity_fields(
        ...
        if frame.group_id != prior_group {
            ...
            // Ascending and backwards under Descending. The Object ID Delta is
            // always written beside it: with the Group ID Delta present the
            // Object ID is read as that delta outright, and leaving it off
            // would carry the previous group's numbering into the new group.
