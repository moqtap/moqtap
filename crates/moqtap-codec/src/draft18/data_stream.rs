...
//!
//! Subgroup header type byte: bit 4 must be set; valid type ranges are
...
//!
//! Fetch header: stream type 0x05 + request_id. Fetch objects use
//! delta-encoded Group ID and Object ID (the first object's deltas are
