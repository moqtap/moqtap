...
/// Object status values, from MoQ Transport draft-08 Section 8.1.1.1
/// "Object Status".
///
...
impl ObjectStatus {
    /// Every status draft-08 assigns, in ascending wire order.
    ///
    ...
    /// Convert a raw u64 to an `ObjectStatus`, or `None` if draft-08 does not
    /// assign that value.
