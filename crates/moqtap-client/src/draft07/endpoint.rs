...
use crate::draft07::fetch::{FetchError, FetchStateMachine};
...
use crate::draft07::subscription::{SubscriptionError, SubscriptionStateMachine};
use crate::draft07::track_status::{TrackStatusError, TrackStatusStateMachine};
...
impl Endpoint {
    /// Create a new draft-07 endpoint.
    pub fn new() -> Self {
        Self {
