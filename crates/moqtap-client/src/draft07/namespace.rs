/// SUBSCRIBE_ANNOUNCES lifecycle states (draft-07).
...
/// ANNOUNCE lifecycle states (draft-07).
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
...
/// State machine for the SUBSCRIBE_ANNOUNCES flow (draft-07).
...
/// State machine for the ANNOUNCE flow (draft-07).
/// Idle → Pending → Active → Done.
