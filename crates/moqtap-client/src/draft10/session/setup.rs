use moqtap_codec::draft10::message::{ClientSetup, ServerSetup};
...
const DRAFT_VERSION: u64 = 0xff00000a;
...
///
/// Section 8.2.2.2 puts no role restriction on MAX_SUBSCRIBE_ID: it
...
///
/// Section 8.2.2.1 on PATH: "It MUST NOT be used by the server, or when
...
///
/// The same sentence in Section 8.2.2.1 forbids PATH "when WebTransport is
