...
use moqtap_codec::draft18::data_stream::{FetchHeader, SubgroupHeader, SubgroupObject};
...
pub enum StreamKind {
    ...
    /// travel on.
    ///
    /// Draft-18 Section 3.3 moved requests off the control plane and gave each
...
pub enum ClientEvent {
    ...
    ControlMessage {
        ...
        /// control stream.
        ///
        /// Draft-18 responses carry no request id: the stream is the
