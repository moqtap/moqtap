...
use moqtap_codec::draft21::data_stream::{FetchHeader, SubgroupHeader, SubgroupObject};
...
pub enum StreamKind {
    ...
    /// Fetch data stream.
    Fetch,
    /// Fill fetch stream, new in draft-20 (Section 3.4).
    ///
    ...
    /// travel on.
    ///
    /// Draft-21 Section 6.3 moved requests off the control plane and gave each
...
pub enum ClientEvent {
    ...
    SetupComplete {
        /// The negotiated MoQT version (from ALPN in draft-21).
    ...
    ControlMessage {
        ...
        /// control stream.
        ///
        /// Draft-21 responses carry no request id: the stream is the
    ...
    ///
    /// PUBLISH_STATE_NOTIFY, new in draft-20 (Section 9.10). Nothing is owed
    ...
    PublishStateNotify {
        ...
        ///
        /// The message itself carries no Request ID field: Section 9.10 makes
