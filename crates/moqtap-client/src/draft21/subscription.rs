...
impl SubscriptionStateMachine {
    ...
    ///
    /// This draft has no UNSUBSCRIBE message. Section 6.4.2.3: "Once a request
    ...
    /// from Active.
    ///
    /// Section 9.5 orders an update against the request rather than against
    ...
    ///
    /// Draft-21 contemplates the case outright. Section 9.1.7 bounds how
