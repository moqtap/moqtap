...
/// carries the objects. Section 9.12: "A publisher MAY send Objects in
/// response to a FETCH before the FETCH_OK message is sent, but the FETCH_OK
/// MUST NOT be sent until the End Location is known."
///
/// Section 9.11 states the other direction of the same freedom: "The
...
impl FetchStateMachine {
    ...
    ///
    /// This draft carries no FETCH_CANCEL message. Section 6.4.2.3: "Once a request
    ...
    /// whichever of QUIC's two endings it is. Section 9.11: a relay whose
    ...
    /// 6.4.2.3 cancels a request by terminating the directions of its stream,
