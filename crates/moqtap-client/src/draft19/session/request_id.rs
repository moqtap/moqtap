...
impl RequestIdAllocator {
    ...
    pub fn new(role: Role) -> Self {
        ...
        // Draft-17 removed MAX_REQUEST_ID and draft-19 keeps it gone;
    ...
    ///
    /// Draft-19 Section 10.1: "The client generates even numbered Request IDs,
    ...
    ///   MAX_REQUEST_ID. Draft-17 removed MAX_REQUEST_ID and draft-19 keeps it
...
mod tests {
    ...
    /// The error names the peer, not the endpoint that caught it. Draft-19
    ...
    /// Draft-17 removed MAX_REQUEST_ID and draft-19 has not brought it back,
