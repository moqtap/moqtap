...
use moqtap_codec::draft19::data_stream::{FetchHeader, SubgroupObject, SubgroupObjectReader};
...
impl FramedSendStream {
    ...
    pub async fn write_subgroup_header(
        ...
        self.inner.write_all(&buf).await?;
        if let AnySubgroupHeader::Draft19(ref d17) = header {
...
impl Connection {
    ...
    ///
    /// Wraps the draft-18 message in `AnyControlMessage::Draft19` for
    /// framing.
