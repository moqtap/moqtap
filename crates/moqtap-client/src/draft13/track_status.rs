...
///
/// This draft renamed the request to TRACK_STATUS and gave it two answers of
/// its own. Section 8.21: "The publisher sends a TRACK_STATUS_OK control
/// message in response to a successful TRACK_STATUS message." A machine with
/// one arrival event for both cannot say which of them ended the request, and
...
///
/// Section 8.20 says what the arriving request is: the receiver "treats it
