...
pub enum ConnectionError {
    ...
    /// A control message this build decoded for draft-13 and then could not
    /// narrow to draft-13's own message type.
    ///
    ...
    #[error(
        "a control message decoded for draft-13 did not narrow to draft-13: a defect in this          build, and evidence about nothing the peer did"
    )]
...
impl Connection {
    ...
    ///
    /// Draft-13 adds none. Every variant of its [`ConnectionError`] is one of the
