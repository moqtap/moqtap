/// SUBSCRIBE_ANNOUNCES lifecycle states (draft-12).
...
/// ANNOUNCE lifecycle states (draft-12).
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
...
/// State machine for the SUBSCRIBE_ANNOUNCES flow (draft-12).
...
/// State machine for the ANNOUNCE flow (draft-12).
/// Idle → Pending → Active → Done.
