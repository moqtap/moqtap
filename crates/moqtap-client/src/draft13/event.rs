//! Client event types emitted by a draft-12 MoQT connection.
...
use moqtap_codec::draft13::message::Publish;
...
///
/// Draft-12 subgroup objects may carry per-object extension headers; the
/// payload captured here is the object body that follows the header.
