...
///
/// Draft-12 Section 8.1: "The client's Request ID starts at 0 and are even and
...
/// plus 1", and closes the session with 'Too Many Requests' on a request ID
/// "equal to or larger than this". Section 8.3.2.2 gives the setup parameter
