...
///
/// Draft-14 Section 9.1: "The client's Request ID starts at 0 and are even and
...
/// plus 1", and closes the session with TOO_MANY_REQUESTS on a request ID
/// "equal to or larger than this". Section 9.3.2.3 gives the setup parameter
/// of the same name a default of 0 and reads that as "the peer MUST NOT send
