...
use moqtap_codec::draft17::data_stream::{FetchHeader, SubgroupObject, SubgroupObjectReader};
...
impl FramedSendStream {
    ...
    pub async fn write_subgroup_header(
        ...
        self.inner.write_all(&buf).await?;
        if let AnySubgroupHeader::Draft17(ref d17) = header {
...
impl Connection {
    ...
    // Draft-17: UNSUBSCRIBE removed. Subscribers end via RequestUpdate or
    // wait for PublishDone.
    ...
    // Draft-17: FETCH_CANCEL removed. Fetchers abort via stream reset.
