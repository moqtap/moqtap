...
use moqtap_codec::draft17::data_stream::{FetchHeader, SubgroupHeader, SubgroupObject};
...
pub enum StreamKind {
    ...
    /// travel on.
    ///
    /// Draft-17 Section 3.3 moved requests off the control plane and gave each
...
pub enum ClientEvent {
    ...
    ControlMessage {
        ...
        /// control stream.
        ///
        /// Draft-17 responses carry no request id: the stream is the
