...
/// carries the objects. Section 9.15: "A publisher MAY send Objects in response
/// to a FETCH before the FETCH_OK message is sent, but the FETCH_OK MUST NOT be
/// sent until the End Location is known."
///
/// Section 9.14.3 states the other direction of the same freedom: "The FETCH_OK
...
impl FetchStateMachine {
    ...
    ///
    /// This draft carries no FETCH_CANCEL message. Section 3.3.1: "Once a request
    ...
    /// whichever of QUIC's two endings it is. Section 9.14.3: a relay whose
    ...
    /// 3.3.1 cancels a request by terminating the directions of its stream,
