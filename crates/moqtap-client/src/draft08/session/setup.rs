use moqtap_codec::draft08::message::{ClientSetup, ServerSetup};
...
const DRAFT_VERSION: u64 = 0xff000008;
...
///
/// Section 7.2.2.2 puts no role restriction on MAX_SUBSCRIBE_ID: it
...
///
/// Section 7.2.2.1 on PATH: "It MUST NOT be used by the server, or when
