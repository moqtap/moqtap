//! Client event types emitted by a draft-08 MoQT connection.
...
///
/// Draft-08 subgroup objects are stateless (no delta encoding, no extension
...
/// Events emitted by a draft-08 MoQT connection.
///
