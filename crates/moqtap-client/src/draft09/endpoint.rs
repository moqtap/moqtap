...
use crate::draft09::fetch::{FetchError, FetchState, FetchStateMachine};
...
use crate::draft09::subscription::{
    SubscriptionError, SubscriptionState, SubscriptionStateMachine,
};
use crate::draft09::track_status::{TrackStatusError, TrackStatusState, TrackStatusStateMachine};
...
use moqtap_codec::draft09::error_codes::{SessionErrorCode, SubscribeErrorCode};
...
impl EndpointError {
    ...
    /// The code to close the session with, when draft-09 answers this error
...
impl Endpoint {
    /// Create a new draft-09 endpoint for the given role.
