...
pub enum ConnectionError {
    ...
    /// A control message this build decoded for draft-09 and then could not
    /// narrow to draft-09's own message type.
    ///
    ...
    #[error(
        "a control message decoded for draft-09 did not narrow to draft-09: a defect in this          build, and evidence about nothing the peer did"
    )]
...
impl Connection {
    ...
    pub async fn recv_control(&mut self) -> Result<ControlMessage, ConnectionError> {
        ...
        match any {
            ...
            // `AnyControlMessage` carries one variant per enabled draft feature. With draft 09 the
    ...
    /// pass. See
    /// [`Endpoint::next_free_track_alias`](crate::draft09::endpoint::Endpoint::next_free_track_alias)
    ...
    ///
    /// Draft-09 adds none. Every variant of its [`ConnectionError`] is one of the
