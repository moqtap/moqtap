//! Client event types emitted by a draft-09 MoQT connection.
...
///
/// Draft-09 subgroup objects are stateless (no delta encoding, no extension
...
/// Events emitted by a draft-09 MoQT connection.
///
