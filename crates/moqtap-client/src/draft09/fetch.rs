...
/// carries the objects. Section 7.17: "A publisher MAY send Objects in response
...
///
/// Section 7.7 says what that freedom is for: a relay "MAY start sending
...
impl FetchStateMachine {
    ...
    /// whichever of QUIC's two endings it is. Section 7.8: the publisher of a
