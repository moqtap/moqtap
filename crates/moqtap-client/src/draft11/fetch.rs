...
/// carries the objects. Section 8.14: "A publisher MAY send Objects in response
/// to a FETCH before the FETCH_OK message is sent, but the FETCH_OK MUST NOT be
/// sent until the end group and object are known."
///
/// Section 8.13 states the other direction of the same freedom: "The FETCH_OK
...
impl FetchStateMachine {
    ...
    /// early leave one behind. Section 8.16: the publisher of a cancelled fetch
    /// "SHOULD promptly close the unidirectional stream, even if it is in the
    /// middle of delivering an object". Section 8.13: a relay whose upstream
